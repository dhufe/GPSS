...
print (prefix) 
fileName = prefix + '_SphericallyRect_Rc_' + str(int(Curv[iCurvIndex]*1e3)) + '_mm_YZ'
...
#    GPSSPlot.PlottingSourceConfiguration(Xs, Ys, Zs)
    ...
    SliceName = prefix + '_SphericallyRect_Rc_' + str(int(Curv[iCurvIndex]*1e3)) + '_mm_YZ_' + sActualFreq + '_kHz'
